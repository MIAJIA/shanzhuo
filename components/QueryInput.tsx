...
export function QueryInput({ onSubmit, loading }: QueryInputProps) {
  ...
  return (
    <div>
      ...
      <div className="border border-[var(--border)] bg-white p-[18px_20px] mb-5 shadow-[inset_0_1px_3px_rgba(0,0,0,0.04)]">
        <textarea
          value={value}
      ...
      <button
        ...
        className="block w-full py-4 bg-[var(--ink)] text-[var(--bg)] font-serif text-sm tracking-[6px] cursor-pointer transition-colors hover:bg-[#2C2A26] disabled:opacity-40 disabled:cursor-not-allowed border-none"
      >
        {loading ? "查　证　中…" : "查　一　下"}
      </button>
    </div>
